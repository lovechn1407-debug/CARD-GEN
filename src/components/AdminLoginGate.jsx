    ...
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 16px', boxSizing: 'border-box' }}>
      <div style={{ background: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '20px', padding: '40px 32px', maxWidth: '440px', width: '100%', boxShadow: '0 20px 40px rgba(15,23,42,0.1)', textAlign: 'center', boxSizing: 'border-box' }}>
        ...
        <p style={{ fontSize: '13px', color: '#64748b', margin: '0 0 24px', lineHeight: 1.6 }}>
          This portal is restricted to the authorized Admin Gmail only. Sign in to access the E-Cell Card Management Dashboard.
        </p>

        {currentAllowedEmail && (
          <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '10px', padding: '10px 14px', marginBottom: '20px', fontSize: '12px', color: '#15803d', display: 'flex', alignItems: 'center', gap: '8px', justifyContent: 'center' }}>
        ...
        {errorMsg && (
          <div style={{ padding: '12px 14px', background: '#fef2f2', border: '1px solid #fecaca', color: '#dc2626', fontSize: '12px', borderRadius: '10px', fontWeight: 600, marginBottom: '20px', textAlign: 'left', display: 'flex', alignItems: 'flex-start', gap: '8px', lineHeight: 1.5 }}>
            <ShieldAlert style={{ width: 18, height: 18, flexShrink: 0, marginTop: '1px' }} />
            <div>{errorMsg}</div>
          </div>
        )}
        ...
        <div style={{ marginTop: '24px', paddingTop: '18px', borderTop: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', fontSize: '11px', color: '#94a3b8' }}>
          ...
          <span>Single-Admin Email Whitelist · Firebase Realtime Database</span>
        </div>
      </div>
    </div>
  );
